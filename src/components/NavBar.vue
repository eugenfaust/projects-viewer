...
<template>
  <div
    class="navbar bg-primary fixed top-0 duration-300 z-30"
    :class="{ '-translate-y-16': isScrolling }"
  >
    <div class="flex-1 ml-2 cursor-pointer">
      <svg
      v-if="screenWidth > 1280 || currentRoute.includes('login')"
      ...
      <a
        class="ml-2 select-none normal-case text-xl text-primary-content"
        @click="homePage"
        >Projects Viewer</a
      >
    </div>
